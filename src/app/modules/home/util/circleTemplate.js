export const circleTemplate = (percentage,{imgURL, name,category})=>{
    const percentageValue =190 + 260* (percentage/100);
    ...
    return/* html */`
        <div class="circle__container d-flex flex-column text-center text-secondary">
            ...
            <svg class="svg__complete" xmlns="http://www.w3.org/2000/svg" version="1.1" width="96px" height="96px">
                <defs>
                    <linearGradient id="GradientColor">
                        <stop offset="0%" stop-color="#DA22FF"></stop>
                        <stop offset="100%" stop-color="#9733EE"></stop>
                ...
                <circle cx="48" cy="48" r="43" stroke-linecap="round" stroke-dashoffset="0"/>
            </svg>
